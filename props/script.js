...
function logPlayer(props) {
  console.log(props.name, props.level);
}

const player = {
    name: "Adinimys The Wizard",
    level: "13",
};
...
function myItem(props) {
  console.log(props.system, props.price);
}

const item = {
    system: "ASUS ROG STRIX",
    price: "$1400"
}

document.body.innerText += `\nThis is the new ${item.system} and it costs ${item.price}.` ;